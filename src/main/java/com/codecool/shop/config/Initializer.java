...
public class Initializer implements ServletContextListener {
    ...
    public void contextInitialized(ServletContextEvent sce) {
        ...
        productDataStore.add(new Product("Organic Metal 300", new BigDecimal("302.9"), "USD", "Stackable chair without armrests, made using natural materials and artisanal processes.", metalChair, chairFactory));
        ...
        productDataStore.add(new Product("Yellow Metal Classic 66", new BigDecimal("869.3"), "USD", "The shearling-style fabric is the ideal way to add warmth, style and contemporary chic to your space.", metalChair, yellowChairs));
        productDataStore.add(new Product("Straight Lines 700", new BigDecimal("179.3"), "USD", "Metal structure with matt black painted finish.", metalChair, chairFactory));
        ...
        productDataStore.add(new Product("Wooden Chair is my Name", new BigDecimal("12.8"), "USD", "The wood sourced is from sustainably-managed forests, where felling is controlled to protect the environment.", woodChair, ecoChair));
        ...
        productDataStore.add(new Product("Coffee Chair", new BigDecimal("7022.8"), "USD", "Amazon's latest Fire HD 8 tablet is a great value for media consumption.", otherChair, ecoChair));
        ...
        productDataStore.add(new Product("Butterfly 888", new BigDecimal("761.2"), "USD", "Upholstered in shearling-style fabric", otherChair, yellowChairs));
